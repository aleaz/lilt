...
First public beta tag (`v0.1.0-beta.1`). Distribution name on packaging metadata is
**`latex-lilt`** (CLI remains `lilt`). Not published to PyPI as `lilt`.
...
[0.1.0b1]: https://github.com/aleaz/lilt/releases/tag/v0.1.0-beta.1
